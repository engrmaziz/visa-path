...
export function LoginForm() {
    ...
    return (
        <div className="flex flex-col gap-6">
            <Button variant="secondary" type="button" onClick={signInWithGoogle} className="w-full gap-2 text-white bg-white/5 border border-white/10 hover:bg-white/10">
            ...
            <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-[#0D1117] px-2 text-[var(--color-text-muted)]">
